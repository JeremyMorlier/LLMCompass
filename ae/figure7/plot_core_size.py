...
core_size_init = pd.read_csv("core_size_results_init.csv", header=None, names=col_names, index_col=0)
core_size_init.index.astype(str)
core_size_ar = pd.read_csv("core_size_results_ar.csv", header=None, names=col_names, index_col=0)
