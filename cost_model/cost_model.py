...
cache_area_efficiency_arr = [0.076, 0.142, 0.247, 0.393, 0.559, 0.704, 0.526, 0.602, 0.561]
...
per_sublane_control_dict = {"nvidia": per_sublane_control_transistor_count, "amd": per_sublane_control_transistor_count}
...
per_core_comm_dict = {"nvidia": per_core_comm_transistor_count, "amd": per_core_comm_transistor_count}
...
def calc_compute_chiplet_area_mm2(configs_dict, verbose=False):
    ...
    per_lane_vector_area = calc_vector_area_mm2(
        vector_int32_count, vector_fp16_count, vector_fp32_count, vector_fp64_count, transistor_density_mil_mm2
    )
    ...
    per_lane_regfile_area = calc_reg_file_area(
        num_reg_files, num_registers, register_bitwidth, num_rdwr_ports, transistor_density_mil_mm2
    )
...
def calc_io_die_area_mm2(config_dict, verbose=False):
    ...
    device_controller_area = calc_mem_controller_area_mm2(
        gpu_gpu_comm_tech, num_gpu_gpu_comm_phy, transistor_density_mil_mm2
    )
